...
class SAMDistributedSampler(DistributedSampler):
    ...
    def __init__(self, dataset: Dataset, num_replicas: Optional[int] = None,
                 ...
                 seed: int = 0, drop_last: bool = False, sub_epochs_per_epoch: int = 1) -> None:
...
class RandomHFlip(object):
    ...
    def __call__(self, sample):
        image, masks, points, bboxs, shape =  sample['image'], sample['masks'], sample['points'], sample['bboxs'], sample['shape']
